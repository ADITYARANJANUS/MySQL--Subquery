CREATE DATABASE littlelemons_db;
USE littlelemons_db;
...
SELECT * FROM MenuItems WHERE Price = (SELECT Price FROM Menus,MenuItems WHERE Menus.ItemID = MenuItems.ItemID AND Type = 'Starters' AND Cuisine = 'Italian');
